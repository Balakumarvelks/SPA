    ...
    <div>
      <div className='flex flex-row justify-between px-3 mt-3'>
        ...
        <div>
          ...
          <button className='bg-black text-white p-3 rounded-lg' onClick={() => setaddadmin(true)}>
            Add Admin
          </button>
        </div>
      </div>
                    ...
                    <div className='container'>
                      ...
                      <div className='flex flex-col gap-3'>
                        ...
                        <div>
                          ...
                          <input type='password' {...register("password")} className='bg-gray-300 w-full p-2 rounded-lg mt-2' placeholder='Enter your Password' required />
                        </div>
